...
from utils.transform_sparsity import transform_sparsity
...
def main():
    ...
    fileHandler = logging.FileHandler(save_path + '/' + 'attack.log')
    ...
    sparsity = transform_sparsity(args)
    logging.info('sparsity:' + str(sparsity))
