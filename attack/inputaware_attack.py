...
from utils.dataset.bd_dataset import prepro_cls_DatasetBD, xy_iter
...
def create_targets_bd(targets, opt):
    if opt.attack_mode == "all2one":
        bd_targets = torch.ones_like(targets) * opt.attack_target
...
def get_arguments():
    ...
    parser.add_argument("--temps", type=str, )
    ...
    parser.add_argument("--lr_M", type=float, )

    parser.add_argument('--C_lr_scheduler', type = str)

    parser.add_argument("--schedulerG_milestones", type=list, )
    parser.add_argument("--schedulerC_milestones", type=list, )
    parser.add_argument("--schedulerM_milestones", type=list, )
    parser.add_argument("--schedulerG_lambda", type=float, )
    parser.add_argument("--schedulerC_lambda", type=float, )
    parser.add_argument("--schedulerM_lambda", type=float, )
    parser.add_argument("--epochs", type=int, )
    parser.add_argument("--lambda_div", type=float, )
    parser.add_argument("--lambda_norm", type=float, )
    parser.add_argument("--num_workers", type=float, )

    parser.add_argument("--attack_target", type=int, )
    parser.add_argument("--attack_mode", type=str, )
    parser.add_argument("--pratio", type=float, )
    parser.add_argument("--mask_density", type=float, )
