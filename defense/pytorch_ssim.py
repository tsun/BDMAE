...
def _ssim(img1, img2, window, window_size, channel, size_average=True, mask=None, weights=None, reduce=False):
...
class SSIM(torch.nn.Module):
    def __init__(self, window_size=11, size_average=True, sigma=1.5):
        ...
        self.register_buffer('window', create_window(window_size, self.channel, self.sigma)) # should be faster
